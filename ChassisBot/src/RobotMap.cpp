...
void RobotMap::init() {
    ...
    drivetrainRobotdrivecontroller->SetSafetyEnabled(true);
        ...
        drivetrainRobotdrivecontroller->SetInvertedMotor(frc::RobotDrive::kFrontRightMotor, false);
        drivetrainRobotdrivecontroller->SetInvertedMotor(frc::RobotDrive::kRearRightMotor, false);
